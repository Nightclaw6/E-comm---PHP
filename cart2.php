						...
						<div class="flex-w flex-t bor12 p-t-15 p-b-30">
							...
							<div class="size-209 p-r-18 p-r-0-sm w-full-ssm">
								<p class="stext-111 cl6 p-t-2">
									We will deliver through our own freight network.
								</p>
								...
								<div class="p-t-15">
									...
									<form action="handler/orderhandler.php" method="POST">			
										...
										<button type="submit" class="flex-c-m stext-101 cl0 size-116 bg3 bor14 hov-btn3 p-lr-15 trans-04 pointer" name="placeorder">
											Place Order
										</button>
									</form>
					</div>
